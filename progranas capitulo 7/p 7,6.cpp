...
int main()
{
    ...
    strcat(cad0,cad3);
    printf("\nPrueba de la función strcat. Se incorpara la cadena cad3 a cad0: %s\n", cad0);
    strcat(cad2,"");
    strncat(cad2,cad0, 4);
    printf("\nPrueba de la función strncat. Se incorpara 4 caracteres cad0 a cad2: %s\n", cad2);
    strcat(cad1,"yy");
    printf("\nPrueba de la función strcat. Se incorpara la cadena yy a cad1: %s\n", cad1);
